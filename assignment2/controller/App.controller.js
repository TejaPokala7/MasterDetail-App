sap.ui.define([
    ...
    /*  onPress: function(oEvent){
      var EmpId = oEvent.getParameter().getBindingContext().getProperty("Emp-id");
      var oFilter = new Filter("Emp-id", FilterOperator.EQ, EmpiId)
      this.getView().byId("empt").getBinding("employee").filter(oFilter, FilterType.Application);
